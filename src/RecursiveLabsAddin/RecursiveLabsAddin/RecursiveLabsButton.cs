...
using ININ.Alliances.RecursiveLabsAddin.view;
...
{
    public class RecursiveLabsButton : IInteractionButton
    {
        ...
        public string Id
        {
            get { return "RL_BUTTON"; }
        }

        public Icon Icon
        {
            get { return Resources.recursive_stamp; }
        }
        ...
        {
            get { return "Click to start a new Recursive Labs cobrowse session"; }
        }
        ...
        public RecursiveLabsButton(Session session)
        {
            try
            {
                _session = session;
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show(
                    "A critical error was encountered on initilization. The Recursive Labs integration will not function. " +
        ...
        private void LoadConfig()
        {
                ...
                parameterConfigurationList.FirstOrDefault(
                    p =>
                        p.ConfigurationId.Id.ToString()
                            .Equals("Recursive Labs Config", StringComparison.InvariantCultureIgnoreCase));
            if (hootsuiteConfig == null)
                throw new Exception("Unable to retrieve Recursive Labs configuration!");
            ...
            var hootsuiteUrls =
                parameterConfigurationList.FirstOrDefault(
                    p =>
                        p.ConfigurationId.Id.ToString()
                            .Equals("Recursive Labs URLs", StringComparison.InvariantCultureIgnoreCase));
        ...
        private void GetAgentInfo(string agentEmail, string agentEmailFromMailbox)
        {
            ...
            {
                AgentName = "Agent";
                AgentEmail = "fakehost@fakedomianname.com";
                return;
            }
            ...
            {
                AgentEmail = string.IsNullOrEmpty(agentEmail) ? "fakehost@fakedomianname.com" : agentEmail;
            }
        ...
        public void Execute(IInteraction selectedInteraction)
        {
            try
            {
                ...
                // Show RecursiveLabs window
                new RecursiveLabsDialog(interaction).Show();
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "Error executing RecursiveLabs Button", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
